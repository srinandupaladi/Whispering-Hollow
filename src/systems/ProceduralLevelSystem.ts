...
import { LevelDefinition, LanternDef, PickupDef } from '../types/GameTypes';
...
export class ProceduralLevelSystem {
  ...
  build() {
    ...
    const exitZone = this.scene.add.zone(this.level.exit.x, this.level.exit.y, 90, 150).setDepth(60);
